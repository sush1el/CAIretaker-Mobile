    ...
    def detect(self, frame):
        ...
        for slot_index, (idx, hailo_det, box, box_conf, keypoints, track_id) in enumerate(frame_persons, start=1):
            ...
            if has_both_shoulders and has_both_knees:
                ...
                # Current CNN result (your existing code)
...
def start_camera():
    """Start camera capture and producer thread (mobile app compatibility endpoint)."""
...
def stop_camera():
    """Stop producer and release camera (mobile app compatibility endpoint)."""
    global camera, camera_initialized
